      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="font-body text-sm font-medium text-[color:var(--rc-bone)]/80 transition hover:text-[color:var(--rc-bone)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[color:var(--rc-plasma)]"
          >
            Log in
          </button>
          <button
            ...
            className="rounded-full bg-[color:var(--rc-blood)] px-4 py-2 font-body text-sm font-semibold text-[color:var(--rc-bone)] transition hover:bg-[color:var(--rc-blood-deep)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[color:var(--rc-plasma)]"
          >
            Become a donor
          </button>
        </div>
